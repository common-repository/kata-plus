...
if ( ! class_exists( 'Kata_Plus_Grid_Main' ) ) {
	class Kata_Plus_Grid_Main {
		...
		public function add_new_grid_columns() {
			...
			$columns['title']         = esc_html__( 'Title', 'kata-plus-pro' );
			$columns['thumbnail']     = esc_html__( 'Thumbnail', 'kata-plus-pro' );
			$columns['author']        = esc_html__( 'Author', 'kata-plus-pro' );
			$columns['grid_category'] = esc_html__( 'Portfolio Categories', 'kata-plus-pro' );
			$columns['date']          = esc_html__( 'Date', 'kata-plus-pro' );
			return $columns;
		}
		...
		public function actions() {
			add_action( 'init', array( $this, 'create_grid_post_type' ), 99 );
