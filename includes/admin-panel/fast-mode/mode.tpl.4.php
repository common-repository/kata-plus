...
<div id="kt-fst-mod-4" class="kt-fst-mod-wrapper">
	<h1 id="page-title" class="chose-bussiness-type"><?php echo esc_html__( 'Contact Information', 'kata-plus-pro' ); ?></h1>
	<div class="kt-fst-mod-inner-wrapper">

		<div class="kt-fst-get-info-row">
			<div class="kt-fst-get-info">
				<label for="site-address" class="kt-fst-get-label"><?php echo esc_html__( 'Address', 'kata-plus-pro' ); ?></label>
				<input type="text" name="site-address" id="site-address" value="<?php echo esc_attr( $address ); ?>">
			</div>
			<div class="kt-fst-get-info">
				<label for="site-phone" class="kt-fst-get-label"><?php echo esc_html__( 'Phone', 'kata-plus-pro' ); ?></label>
				<input type="text" name="site-phone" id="site-phone" value="<?php echo esc_attr( $phone ); ?>">
			</div>
		</div>

		<label for="site-socials" class="kt-fst-get-label"><?php echo esc_html__( 'Socials', 'kata-plus-pro' ); ?></label>
		<div class="kt-fst-get-info-row">
