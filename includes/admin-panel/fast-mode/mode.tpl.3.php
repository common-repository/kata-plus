...
<div id="kt-fst-mod-3" class="kt-fst-mod-wrapper">
	<h1 id="page-title" class="chose-bussiness-type"><?php echo esc_html__( 'Logo & Icon', 'kata-plus-pro' ); ?></h1>
	<div class="kt-fst-mod-inner-wrapper">
		<div class="kt-fst-get-info-row">
			<div class="kt-fst-get-info site-logo-icon site-icon">
				<p><?php echo esc_html__( 'Site Icon', 'kata-plus-pro' ); ?></p>
				<div class="image-place-holder" style="<?php echo esc_attr( $icon ); ?>"></div>
				<a href="#" class="change-image" data-frame-title="<?php echo esc_attr( 'Upload Site Icon', 'kata-plus-pro' ); ?>" data-insert-title="<?php echo esc_attr( 'Set as site icon', 'kata-plus-pro' ); ?>"><?php echo esc_html__( 'Change', 'kata-plus-pro' ); ?></a>
				<i><?php echo esc_html__( 'Site Icons should be square.', 'kata-plus-pro' ); ?></i>
				<i><?php echo esc_html__( 'Recommended size: 512 × 512 pixels.', 'kata-plus-pro' ); ?></i>
			</div>
			<div class="kt-fst-get-info site-logo-icon site-logo">
				<p><?php echo esc_html__( 'Logo', 'kata-plus-pro' ); ?></p>
				<div class="image-place-holder" style="<?php echo esc_attr( $logo ); ?>"></div>
				<a href="#" class="change-image" data-frame-title="<?php echo esc_attr( 'Upload Logo', 'kata-plus-pro' ); ?>" data-insert-title="<?php echo esc_attr( 'Set as site logo', 'kata-plus-pro' ); ?>"><?php echo esc_html__( 'Change', 'kata-plus-pro' ); ?></a>
			</div>
		</div>
	</div>
</div>
