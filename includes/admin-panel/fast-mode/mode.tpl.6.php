...
<div id="kt-fst-mod-6" class="kt-fst-mod-wrapper">
	<h1 id="page-title" class="chose-bussiness-type">
		...
		<?php echo esc_html__( 'Your website is ready to launch', 'kata-plus-pro' ); ?>
	</h1>
	<div class="site-ready-wrapper">
		<div class="col">
			...
			<h3><?php echo esc_html__( 'Launch the website right now.', 'kata-plus-pro' ); ?></h3>
			<p><?php echo esc_html__( 'You can now see the website with the default content and you can edit it at any time.', 'kata-plus-pro' ); ?></p>
			<a href="<?php echo esc_url( home_url() ); ?>"><?php echo esc_html__( 'Visit Site', 'kata-plus-pro' ); ?></a>
		</div>
		<div class="col">
			...
			<h3><?php echo esc_html__( 'Edit website’s content and design.', 'kata-plus-pro' ); ?></h3>
			<p><?php echo esc_html__( 'You can easily customize the content and design of the website using the visual editor.', 'kata-plus-pro' ); ?></p>
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=kata-plus-fast-mode&step=7' ) ); ?>"><?php echo esc_html__( 'Edit Site', 'kata-plus-pro' ); ?></a>
		</div>
	</div>
</div>
